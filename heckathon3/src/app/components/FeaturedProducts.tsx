            ...
            >
                ...
                <div className="flex justify-center items-center h-full">
                  {query.imageUrl && (
                    <Image
                      ...
                      src={urlFor(query.imageUrl).url()}
                      alt={query.name || "Product Image"}
                      width={228}
                      height={178}
              ...
              <div className="p-4 text-center transition-colors duration-300 group-hover:bg-[#2f1ac4]">
                ...
                <div className="absolute inset-0 flex items-end justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
                  <Link href={'/details/'+query._id} className="mb-36 px-6 py-2 bg-[#08D15F] text-white font-bold rounded shadow-lg transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    View Details
                  </Link>
                </div>
